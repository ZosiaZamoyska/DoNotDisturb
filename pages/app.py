...
def update(timeInput, time, granularity, app): 
    ...
    if timeInput is None:
        return  html.Div(id='errorDiv', children=[html.Img(id="errorImg",
                        className="img-fluid", src='https://img.freepik.com/premium-vector/hourglass-icon-comic-style-sandglass-cartoon-vector-illustration-white-isolated-background-clock-splash-effect-business-concept_157943-6412.jpg?w=2000'),
        ...
        return  html.Div(id='errorDiv', children=[html.Img(id="errorImg",
                        className="img-fluid", src='https://img.freepik.com/free-vector/page-found-concept-illustration_114360-1869.jpg?w=2000'),
...
def add_value_to_dataframe(n_clicks, time_stm, app, value):
    ...
    if value is None:
        ...
        if df_timeLimit.empty: 
            return  html.Div(id='errorDiv', children=[html.Img(id="errorImg",
                        className="img-fluid", src='https://cdn0.iconfinder.com/data/icons/man-using-phone/141/man-using-phone-person-030-512.png'),
